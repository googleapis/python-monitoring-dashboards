...
class DashboardsServiceClient(object):
    ...
    def list_dashboards(
        ...
        Args:
            parent (str): Align and convert to a percentage change. This alignment is valid
    ...
    def delete_dashboard(
        ...
        Args:
            name (str): Reduce by computing the mean across time series for each alignment

...
from google.cloud.monitoring_dashboard_v1.services.dashboards_service import DashboardsServiceAsyncClient
...
@pytest.mark.parametrize("client_class", [
    DashboardsServiceClient, DashboardsServiceAsyncClient
])
@mock.patch.object(DashboardsServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DashboardsServiceClient))
@mock.patch.object(DashboardsServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DashboardsServiceAsyncClient))
...
def test_list_dashboards_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, dashboard.Dashboard)
                   for i in results)
...
def test_create_dashboard_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.DashboardsServiceRestInterceptor, "post_create_dashboard") as post, \
         mock.patch.object(transports.DashboardsServiceRestInterceptor, "pre_create_dashboard") as pre:
...
def test_list_dashboards_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DashboardsServiceRestInterceptor, "post_list_dashboards") as post, \
         mock.patch.object(transports.DashboardsServiceRestInterceptor, "pre_list_dashboards") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_dashboard_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DashboardsServiceRestInterceptor, "post_get_dashboard") as post, \
         mock.patch.object(transports.DashboardsServiceRestInterceptor, "pre_get_dashboard") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_dashboard_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DashboardsServiceRestInterceptor, "pre_delete_dashboard") as pre:
        pre.assert_not_called()
...
def test_update_dashboard_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.DashboardsServiceRestInterceptor, "post_update_dashboard") as post, \
         mock.patch.object(transports.DashboardsServiceRestInterceptor, "pre_update_dashboard") as pre:
        pre.assert_not_called()
        post.assert_not_called()

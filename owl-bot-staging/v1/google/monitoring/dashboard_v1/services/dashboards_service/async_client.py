...
class DashboardsServiceAsyncClient:
    ...
    async def create_dashboard(self,
        ...
        Args:
            request (Optional[Union[google.monitoring.dashboard_v1.types.CreateDashboardRequest, dict]]):
    ...
    async def list_dashboards(self,
        ...
        Args:
            request (Optional[Union[google.monitoring.dashboard_v1.types.ListDashboardsRequest, dict]]):
    ...
    async def get_dashboard(self,
        ...
        Args:
            request (Optional[Union[google.monitoring.dashboard_v1.types.GetDashboardRequest, dict]]):
    ...
    async def delete_dashboard(self,
        ...
        Args:
            request (Optional[Union[google.monitoring.dashboard_v1.types.DeleteDashboardRequest, dict]]):
    ...
    async def update_dashboard(self,
        ...
        Args:
            request (Optional[Union[google.monitoring.dashboard_v1.types.UpdateDashboardRequest, dict]]):

    ...
    *reduced* in number.
    ...
    Attributes:
        alignment_period (google.protobuf.duration_pb2.Duration):
            ...
            104 weeks.
        per_series_aligner (google.monitoring.dashboard_v1.types.Aggregation.Aligner):
        ...
        cross_series_reducer (google.monitoring.dashboard_v1.types.Aggregation.Reducer):
...
class PickTimeSeriesFilter(proto.Message):
    ...
    Attributes:
        ranking_method (google.monitoring.dashboard_v1.types.PickTimeSeriesFilter.Method):
        ...
        num_time_series (int):
            ...
            the filter.
        direction (google.monitoring.dashboard_v1.types.PickTimeSeriesFilter.Direction):
    ...
    ranking_method = proto.Field(proto.ENUM, number=1,
        enum=Method,
    )

    num_time_series = proto.Field(proto.INT32, number=2)

    direction = proto.Field(proto.ENUM, number=3,
        enum=Direction,
    )
...
class StatisticalTimeSeriesFilter(proto.Message):
    ...
    Attributes:
        ranking_method (google.monitoring.dashboard_v1.types.StatisticalTimeSeriesFilter.Method):

...
class XyChart(proto.Message):
    ...
    Attributes:
        data_sets (MutableSequence[google.monitoring.dashboard_v1.types.XyChart.DataSet]):
        ...
        timeshift_duration (google.protobuf.duration_pb2.Duration):
            ...
            type.
        thresholds (MutableSequence[google.monitoring.dashboard_v1.types.Threshold]):
        ...
        y2_axis (google.monitoring.dashboard_v1.types.XyChart.Axis):
    ...
    class DataSet(proto.Message):
        ...
        Attributes:
            ...
            min_alignment_period (google.protobuf.duration_pb2.Duration):
                ...
                intervals.
            target_axis (google.monitoring.dashboard_v1.types.XyChart.DataSet.TargetAxis):

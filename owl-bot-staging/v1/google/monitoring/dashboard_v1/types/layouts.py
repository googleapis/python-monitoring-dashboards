...
class GridLayout(proto.Message):
    ...
    Attributes:
        ...
        widgets (MutableSequence[google.monitoring.dashboard_v1.types.Widget]):
...
class MosaicLayout(proto.Message):
    ...
    Attributes:
        columns (int):
            ...
            inclusive.
        tiles (MutableSequence[google.monitoring.dashboard_v1.types.MosaicLayout.Tile]):
    ...
    class Tile(proto.Message):
        ...
        Attributes:
            ...
            widget (google.monitoring.dashboard_v1.types.Widget):
...
class RowLayout(proto.Message):
    ...
    Attributes:
        rows (MutableSequence[google.monitoring.dashboard_v1.types.RowLayout.Row]):
...
class ColumnLayout(proto.Message):
    ...
    Attributes:
        columns (MutableSequence[google.monitoring.dashboard_v1.types.ColumnLayout.Column]):

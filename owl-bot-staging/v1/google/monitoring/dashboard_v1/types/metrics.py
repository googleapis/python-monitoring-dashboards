...
class TimeSeriesQuery(proto.Message):
    ...
    Attributes:
        time_series_filter (google.monitoring.dashboard_v1.types.TimeSeriesFilter):
            Filter parameters to fetch time series.

            This field is a member of `oneof`_ ``source``.
        time_series_filter_ratio (google.monitoring.dashboard_v1.types.TimeSeriesFilterRatio):
...
class TimeSeriesFilter(proto.Message):
    ...
    Attributes:
        filter (str):
            ...
            query.
        aggregation (google.monitoring.dashboard_v1.types.Aggregation):
        ...
        secondary_aggregation (google.monitoring.dashboard_v1.types.Aggregation):
            Apply a second aggregation after ``aggregation`` is applied.
        pick_time_series_filter (google.monitoring.dashboard_v1.types.PickTimeSeriesFilter):
            Ranking based time series filter.

            This field is a member of `oneof`_ ``output_filter``.
        statistical_time_series_filter (google.monitoring.dashboard_v1.types.StatisticalTimeSeriesFilter):
...
class TimeSeriesFilterRatio(proto.Message):
    ...
    Attributes:
        numerator (google.monitoring.dashboard_v1.types.TimeSeriesFilterRatio.RatioPart):
            The numerator of the ratio.
        denominator (google.monitoring.dashboard_v1.types.TimeSeriesFilterRatio.RatioPart):
...
class Threshold(proto.Message):
    ...
    Attributes:
        ...
        color (google.monitoring.dashboard_v1.types.Threshold.Color):
            The state color for this threshold. Color is
            not allowed in a XyChart.
        direction (google.monitoring.dashboard_v1.types.Threshold.Direction):
            The direction for the current threshold.
            Direction is not allowed in a XyChart.
        target_axis (google.monitoring.dashboard_v1.types.Threshold.TargetAxis):

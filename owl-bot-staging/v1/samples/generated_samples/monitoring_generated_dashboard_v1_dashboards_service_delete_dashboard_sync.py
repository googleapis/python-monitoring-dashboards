...
# [START monitoring_generated_dashboard_v1_DashboardsService_DeleteDashboard_sync]
...
def sample_delete_dashboard():
    ...
    # Make the request
    response = client.delete_dashboard(request=request)


# [END monitoring_generated_dashboard_v1_DashboardsService_DeleteDashboard_sync]
